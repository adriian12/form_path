...
function comprobar() {
    ...
    if (document.getElementById("text").value == "") {
        ...
        return false;
    } else if (document.getElementById("selMul").selectedIndex == -1) {
        document.getElementById("selMul").scrollIntoView();
        alert("Responde la 3ª pregunta");
        return false;
    } else if (!checked) {
        ...
        alert("Selecciona una opción en la 5ª pregunta");
        return false;
    } else if (!checked2) {
        document.getElementById("tituloCheckbox2").scrollIntoView();
        alert("Debes elegir una opción en la 6ª pregunta");
        return false;
    } else if (document.getElementById("text2").value == "") {
        document.getElementById("tituloInput2").focus();
        alert("La 7ª pregunta es obligatoria");
        return false;
    } else if (document.getElementById("sel2").selectedIndex == 0) {
        document.getElementById("tituloSelect").focus();
        alert("Selecciona una de las opciones en la 8ª pregunta");
        return false;
    } else if (document.getElementById("selMul2").selectedIndex == -1) {
        alert("Responde la 9ª pregunta");
        document.getElementById("selMul2").scrollIntoView;
        return false;
    } else if (!radioSelected2) {
        document.getElementById("tituloRadio2").scrollIntoView();
        alert("Selecciona una opción en la 10ª pregunta");
        return false;
    } else return true;
}